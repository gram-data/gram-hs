...
-- at runtime using the environment variable pattern_bindir.
...
-- environment variable pattern_libdir.
...
-- using the environment variable pattern_dynlibdir.
...
-- runtime using the environment variable pattern_datadir.
...
-- using the environment variable pattern_sysconfdir.
...
libdir     = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.10.3-b4c3/pattern-0.1.0.0-inplace-pattern-test"
dynlibdir  = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.10.3-b4c3"
datadir    = "/home/runner/.cabal/share/x86_64-linux-ghc-9.10.3-b4c3/pattern-0.1.0.0"
libexecdir = "/home/runner/.cabal/libexec/x86_64-linux-ghc-9.10.3-b4c3/pattern-0.1.0.0"
sysconfdir = "/home/runner/.cabal/etc"

getBinDir     = catchIO (getEnv "pattern_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "pattern_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "pattern_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "pattern_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "pattern_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "pattern_sysconfdir") (\_ -> return sysconfdir)
